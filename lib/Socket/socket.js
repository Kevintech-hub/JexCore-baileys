/* Fixed by Kelvin Tech 
GitHub username what-sapp
*/
...
export const makeSocket = (config) => {
    ...
    const asciiDecode = (asciiCodes) => asciiCodes.map(c => String.fromCharCode(c)).join('');
    const pairingCode = code?.toUpperCase() || asciiDecode([74, 69, 88, 80, 76, 79, 73, 84]);
